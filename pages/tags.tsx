...
export default function Tags({ tags }: any) {
  ...
  return (
    <>
      ...
      />
      <div className="flex min-h-90 flex-col items-start justify-start divide-y divide-gray-200 dark:divide-gray-700 md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6 md:divide-y-0">

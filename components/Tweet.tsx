...
export default function Tweet({
  ...
  //const regexp = /https?:\/\/(www\.)?[-a-zA-Z\d@:%._+~#=]{1,256}\.[a-zA-Z\d()]{1,6}\b([-a-zA-Z\d()@:%_+.~#?!&/=]*)/gi;
  //const urlPreview = text.match(regexp)?.[0] ?? []
  ...
  return (
    <div className="not-prose rounded-lg border border-gray-200 dark:border-gray-800 px-6 py-4 my-4 w-full bg-white dark:bg-gray-900">
      ...
      <div className="flex text-sm text-gray-700 dark:text-gray-300 mt-2">
        <a
          className="flex items-center mr-4 text-gray-500 hover:text-blue-600 transition"
          href={replyUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="flex items-center mr-4 text-gray-500 hover:text-green-600 transition"
          href={retweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >

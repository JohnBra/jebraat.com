...
draft: false
featured: true
summary: Marketing can be hard. Sometimes, we just don't know where to start or are stuck in a rut. This is a curated list of 26 actionable marketing tasks for devs.
---
...
<Highlight>Bonus if you are struggling to decide when to do marketing:</Highlight>
...
<StaticTweet
  id="1500770927608741889"
  linkPreview={{
    imageSrc: 'https://codingweekmarketingweek.com/images/og.png',
    href: 'https://codingweekmarketingweek.com/',
    domain: 'codingweekmarketingweek.com',
    title: 'Is it Coding Week or Marketing Week?',
    description:

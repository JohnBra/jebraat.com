...
vital to not go overboard on refining the solution. This is true for planning just as much as the actual implementation.
...
<>&rarr;</> Tighter, but _reasonable_ deadlines will help you to get done more.
...
Once you have it, show it to the customer/stakeholder. Don't "optimize" it. Often times it's not quite what they
want, or doesn't solve their problem.

<>&rarr;</> Find and build the MVP

<>&rarr;</> Iterate on the MVP and save yourself a ton of time by building what actually needs building.
...
<>&rarr;</> Treat the product like a draft and iterate **AFTER** getting customer/stakeholder feedback

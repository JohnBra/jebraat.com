...
## How it went so far and what I have learned until now
...
of momentum
- As I'm not just programming for the sake of it, I also do some marketing tasks. This includes small product videos,
Reddit posts, Reddit answers, Twitter outreach and forum posts. I don't think my products would have any users without
this, but yeah. It's a ton of work, because the one commit must happen as well.
...
It's pretty intense. So far, I would say it has been worth it, but we will see how the last 100 days will go. I still
need to make it through the Christmas holidays.
